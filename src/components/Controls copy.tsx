    ...
    return (
        <div className="flex flex-col items-center gap-4">
            <Button
                ...
                onClick={onStart}
                className={`
                    w-full max-w-xs transition-all duration-200 cursor-pointer ${isRunning ? "bg-orange-500 hover:bg-orange-600" :
           ...
           <div className="flex gap-3 w-full max-w-xs">
            ...
            <Button
                variant="secondary"
                size="lg" //このコードが抜けていたのでモード切替ボタンが小さく表示され、リセットボタンと高さが合わなかった～～；
